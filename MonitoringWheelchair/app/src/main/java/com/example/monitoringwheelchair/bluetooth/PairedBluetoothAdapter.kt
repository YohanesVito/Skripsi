...
import com.example.monitoringwheelchair.R

class PairedBluetoothAdapter(private val context: Context, private val listPairedDevice: ArrayList<BluetoothDevice>) : RecyclerView.Adapter<PairedBluetoothAdapter.ListViewHolder>() {
